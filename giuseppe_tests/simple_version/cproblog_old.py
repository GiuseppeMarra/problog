...
class SimpleConstrainedLogicProgram(ConstrainedLogicProgram):
    """LogicProgram"""

    def __init__(self, source_root='.', source_files=None, line_info=None, **extra_info):
        super(SimpleConstrainedLogicProgram, self).__init__(source_root, source_files, line_info, **extra_info)
        self.__clauses = []
        self.__constraints = []
    ...
    def add_constraint(self, constraint, scope=None):
        if type(constraint) is list:
            ...
            self.__clauses.append(constraint)
...
class ConstrainedClauseDB(ConstrainedLogicProgram):
    ...
    _constraint = namedtuple('constraint', ('functor','child', 'location'))

    FUNCTOR_CHOICE = 'choice'
    FUNCTOR_BODY = 'body'

    def __init__(self, builtins=None, parent=None):
        super(ConstrainedClauseDB, self).__init__()
